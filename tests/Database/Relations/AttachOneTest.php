...
use Winter\Storm\Tests\Database\Fixtures\Models\SoftDeleteUser;
...
class AttachOneTest extends DbTestCase
{
    ...
    public function testSetRelationValue()
    {
        ...
        // Set by string
        $user->avatar = $this->assetPath . '/avatar.png';
    ...
    public function testDeleteFlagDestroyRelationship()
    {
        ...
        $user->avatar()->create(['data' => $this->assetPath . '/avatar.png']);
