...
use Winter\Storm\Tests\Database\Fixtures\Models\Tag;
...
class MorphManyTest extends DbTestCase
{
    ...
    public function testSetRelationValue()
    {
        ...
        $this->assertEquals('Winter\Storm\Tests\Database\Fixtures\Models\Author', $event1->related_type);
        $this->assertEquals('Winter\Storm\Tests\Database\Fixtures\Models\Author', $event2->related_type);
        $this->assertEquals([
            'user-created',
            'user-updated'
        ...
        $this->assertEquals('Winter\Storm\Tests\Database\Fixtures\Models\Author', $event3->related_type);
        $this->assertEquals([
            'user-deleted'
        ], $author->event_log->lists('action'));
        ...
        $this->assertEquals('Winter\Storm\Tests\Database\Fixtures\Models\Author', $event4->related_type);
        $this->assertEquals([
            'user-restored'
        ], $author->event_log->lists('action'));
    }
    ...
    public function testGetRelationValue()
    {
        ...
        $event1 = EventLog::create(['action' => "user-created", 'related_id' => $author->id, 'related_type' => 'Winter\Storm\Tests\Database\Fixtures\Models\Author']);
        $event2 = EventLog::create(['action' => "user-updated", 'related_id' => $author->id, 'related_type' => 'Winter\Storm\Tests\Database\Fixtures\Models\Author']);
        Model::reguard();
