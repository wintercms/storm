...
use Winter\Storm\Tests\Database\Fixtures\Models\CategoryNestedTree;
...
class NestedTreeTest extends DbTestCase
{
    ...
    {
        $items = CategoryNestedTree::getNested();
    ...
    {
        $items = CategoryNestedTree::getAllRoot();
    ...
    {
        $array = CategoryNestedTree::listsNested('name', 'id');
        $this->assertEquals([
            1 => 'Category Orange',
            2 => '&nbsp;&nbsp;&nbsp;Autumn Leaves',
            3 => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;September',
        ...
        CategoryNestedTree::flushDuplicateCache();
        ...
        $array = CategoryNestedTree::listsNested('description', 'name', '**');
        $this->assertEquals([
    ...
    {
        $array = CategoryNestedTree::get()->listsNested('custom_name', 'id', '...');
        $this->assertEquals([
            1 => 'Category Orange (#1)',
            2 => '...Autumn Leaves (#2)',
            3 => '......September (#3)',
    ...
    public function seedSampleTree()
    {
        ...
        $orange = CategoryNestedTree::create([
        ...
        $green = CategoryNestedTree::create([
            'name' => 'Category Green',
            'description' => 'A root level test category',
        ]);
