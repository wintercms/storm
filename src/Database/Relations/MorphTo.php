...
class MorphTo extends MorphToBase
{
    ...
    public function __construct(Builder $query, Model $parent, $foreignKey, $relatedKey, $type, $relationName)
    {
        $this->relationName = $relationName;

        parent::__construct($query, $parent, $foreignKey, $relatedKey, $type, $relationName);
