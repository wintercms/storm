...
class CreateController extends GeneratorCommand
{
    ...
    public function handle()
    {
        if ($this->option('with-translations')) {
            $this->stubs = array_merge($this->stubs, [
                'controller/_list_toolbar-with-translations.stub' => 'controllers/{{lower_name}}/_list_toolbar.htm',
                'controller/create-with-translations.stub'        => 'controllers/{{lower_name}}/create.htm',
                'controller/preview-with-translations.stub'       => 'controllers/{{lower_name}}/preview.htm',
                'controller/update-with-translations.stub'        => 'controllers/{{lower_name}}/update.htm',
            ]);
        } else {
            $this->stubs = array_merge($this->stubs, [
    ...
    protected function getOptions()
    {
        return [
            ...
            ['with-translations', null, InputOption::VALUE_NONE, 'Generate view files with translation keys.'],
        ];
    }
}
