...
class_alias(\Assetic\Asset\AssetCollectionInterface::class, \October\Rain\Assetic\Asset\AssetCollectionInterface::class);
class_alias(\Assetic\Asset\AssetInterface::class, \October\Rain\Assetic\Asset\AssetInterface::class);
...
class_alias(\Assetic\Cache\ApcCache::class, \October\Rain\Assetic\Cache\ApcCache::class);
class_alias(\Assetic\Cache\ArrayCache::class, \October\Rain\Assetic\Cache\ArrayCache::class);
class_alias(\Assetic\Cache\CacheInterface::class, \October\Rain\Assetic\Cache\CacheInterface::class);
...
class_alias(\Assetic\Exception\Exception::class, \October\Rain\Assetic\Exception\Exception::class);
...
class_alias(\Assetic\Factory\Loader\FormulaLoaderInterface::class, \October\Rain\Assetic\Factory\Loader\FormulaLoaderInterface::class);
...
class_alias(\Assetic\Factory\Resource\IteratorResourceInterface::class, \October\Rain\Assetic\Factory\Resource\IteratorResourceInterface::class);
class_alias(\Assetic\Factory\Resource\ResourceInterface::class, \October\Rain\Assetic\Factory\Resource\ResourceInterface::class);
...
class_alias(\Assetic\Factory\Worker\WorkerInterface::class, \October\Rain\Assetic\Factory\Worker\WorkerInterface::class);
...
class_alias(\Assetic\Filter\DependencyExtractorInterface::class, \October\Rain\Assetic\Filter\DependencyExtractorInterface::class);
class_alias(\Assetic\Filter\FilterCollection::class, \October\Rain\Assetic\Filter\FilterCollection::class);
class_alias(\Assetic\Filter\FilterInterface::class, \October\Rain\Assetic\Filter\FilterInterface::class);
class_alias(\Assetic\Filter\HashableInterface::class, \October\Rain\Assetic\Filter\HashableInterface::class);
...
class_alias(\Assetic\Filter\PackagerFilter::class, \October\Rain\Assetic\Filter\PackagerFilter::class);
...
class_alias(\Winter\Storm\Parse\Assetic\Filter\StylesheetMinify::class, \October\Rain\Assetic\Filter\StylesheetMinify::class);
